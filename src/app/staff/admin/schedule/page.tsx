...
export default async function AdminSchedulePage() {
  ...
  const entries = await getAllScheduleSubmissions(initialMonthStart, monthEnd(initialMonthStart));
  ...
  return (
    <div className="flex max-w-3xl flex-col gap-4">
      ...
      <ScheduleReviewPanel initialMonthStart={initialMonthStart} initialEntries={entries} />
    </div>
  );
}
